...
class Adam():
    ...
    Attributes:
        ...
        alpha (float): Coefficient used for computing running averages of squared gradients. Default: 0.9.
    ...
    """
    def __init__(self, params, lr: float = 0.01, alpha: float = 0.9, momentum: float = 0.9, eps: float = 0.00000001):
        pass
